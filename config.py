...
__C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH    = '/home/lch/Downloads/SVT3D/datasets/ShapeNet.json'
#__C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH  = './datasets/PascalShapeNet.json'
__C.DATASETS.SHAPENET.RENDERING_PATH        = '/home/lch/Downloads/SVT3D/ShapeNetRendering/%s/%s/rendering/%02d.png'

__C.DATASETS.SHAPENET.VOXEL_PATH            = '/home/lch/Downloads/SVT3D/ShapeNetVox32/%s/%s/model.binvox'
__C.DATASETS.PIX3D                          = edict()
__C.DATASETS.PIX3D.TAXONOMY_FILE_PATH       = 'datasets/Pix3D.json'
__C.DATASETS.PIX3D.ANNOTATION_PATH          = '/home/lch/Downloads/SVT3D/pix3d/pix3d.json'
__C.DATASETS.PIX3D.RENDERING_PATH           = '/home/lch/Downloads/SVT3D/pix3d/img/%s/%s.%s'
__C.DATASETS.PIX3D.VOXEL_PATH               = '/home/lch/Downloads/SVT3D/pix3d/model/%s/%s/%s.binvox'
# Dataset
__C.DATASET = edict()
...
__C.CONST.IMG_W = 224  # Image w    idth for input
__C.CONST.IMG_H = 224  # Image height for input
__C.CONST.CROP_IMG_W = 128  # Dummy property for Pascal 3D
__C.CONST.CROP_IMG_H = 128  # Dummy property for Pascal 3D
__C.CONST.BATCH_SIZE_PER_GPU = 10
...
# Directories
__C.DIR = edict()
__C.DIR.OUT_PATH = '/home/lch/SVT3D/output/'
